...
export class StreamingFixtures {
  ...
  static readonly CODE_EXPLANATION: StreamingScenario = {
    ...
    finalContent:
      "Looking at your code, I can see that this function handles user input validation. Here are some improvements:\n\n1. Add error handling\n2. Validate input types\n3. Return meaningful errors",
  };
  ...
  static async simulateStreaming(
    ...
    for (let i = 0; i < scenario.chunks.length; i++) {
      ...
      if (
        scenario.shouldAbort &&
        scenario.abortAtChunk &&
        i >= scenario.abortAtChunk
      ) {
