...
// 面板收起/展开切换 — Figma 功能图标「收起面板」(13383:4717) / 「展开面板」
// (13383:4720)：面板 outline + 指向 chevron。展开态显示「收起面板」图标，
// 收起态显示「展开面板」图标；fill 原稿 #565A60 → currentColor。
export const PanelCollapseIcon: React.FC<IconProps> = ({
  className = "header-icon",
}) => (
  <svg
    width={24}
  ...
  >
    <path
      d="M8.79492 9.49512C9.06817 9.2219 9.51177 9.22211 9.78516 9.49512L11.7949 11.5049L11.8818 11.6113C11.9581 11.7255 12 11.8607 12 12C12 12.1856 11.9262 12.3639 11.7949 12.4951L9.78516 14.5049C9.51178 14.7779 9.06818 14.7781 8.79492 14.5049C8.522 14.2316 8.52201 13.7879 8.79492 13.5146L10.3096 12L8.79492 10.4854C8.52199 10.2121 8.52202 9.76841 8.79492 9.49512Z"
      fill="currentColor"
    />
    <path
      d="M16.75 5.5498C18.2412 5.5498 19.4502 6.75883 19.4502 8.25V15.75C19.4502 17.2412 18.2412 18.4502 16.75 18.4502H7.25C5.75883 18.4502 4.5498 17.2412 4.5498 15.75V8.25C4.5498 6.75883 5.75883 5.5498 7.25 5.5498H16.75ZM7.25 6.9502C6.53203 6.9502 5.9502 7.53203 5.9502 8.25V15.75C5.9502 16.468 6.53203 17.0498 7.25 17.0498H14.2344V6.9502H7.25ZM15.6348 6.9502V17.0498H16.75C17.468 17.0498 18.0498 16.468 18.0498 15.75V8.25C18.0498 7.53203 17.468 6.9502 16.75 6.9502H15.6348Z"
      fill="currentColor"
    />
  </svg>
);

export const PanelExpandIcon: React.FC<IconProps> = ({
  className = "header-icon",
}) => (
  <svg
    width={24}
...
export const ConversationCloseIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      d="M16.2474 7.76379C16.5098 8.02615 16.5096 8.45148 16.2474 8.71396L12.9448 12.0166L16.2363 15.3082C16.4985 15.5706 16.4987 15.996 16.2363 16.2583C15.9739 16.5207 15.5486 16.5205 15.2861 16.2583L11.9946 12.9668L8.71427 16.2471C8.45179 16.5093 8.02647 16.5095 7.7641 16.2471C7.50173 15.9848 7.50191 15.5594 7.7641 15.2969L11.0444 12.0166L7.74179 8.714C7.47962 8.45151 7.47943 8.02619 7.74179 7.76382C8.00416 7.50147 8.42949 7.50166 8.69197 7.76382L11.9946 11.0665L15.2973 7.76379C15.5597 7.50164 15.9851 7.50143 16.2474 7.76379Z"
      fill="currentColor"
    />
  </svg>
);

/** 侧边栏收起入口图标 — Figma 功能图标「收起侧边栏」(13383:4518，24 artboard：
 *  面板 + 左侧内容条 + 指向右 chevron，点击后侧栏收起）。fill #565A60 →
 *  currentColor。按钮规格由 .desktop-sidebar-more-btn（24×24）提供。 */
export const CollapseIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      d="M14.4482 9.49512C14.7216 9.22204 15.1652 9.22204 15.4385 9.49512C15.7115 9.76845 15.7116 10.2121 15.4385 10.4854L13.9238 12L15.4385 13.5146C15.7115 13.788 15.7115 14.2316 15.4385 14.5049C15.1652 14.778 14.7216 14.7779 14.4482 14.5049L12.4385 12.4951C12.3074 12.3639 12.2334 12.1855 12.2334 12C12.2334 11.8607 12.2754 11.7255 12.3516 11.6113L12.4385 11.5049L14.4482 9.49512Z"
      fill="currentColor"
    />
    <path
      d="M16.75 5.5498C18.2412 5.5498 19.4502 6.75883 19.4502 8.25V15.75C19.4502 17.2412 18.2412 18.4502 16.75 18.4502H7.25C5.75883 18.4502 4.5498 17.2412 4.5498 15.75V8.25C4.5498 6.75883 5.75883 5.5498 7.25 5.5498H16.75ZM7.25 6.9502C6.53203 6.9502 5.9502 7.53203 5.9502 8.25V15.75C5.9502 16.468 6.53203 17.0498 7.25 17.0498H8.36523V6.9502H7.25ZM9.76562 17.0498H16.75C17.468 17.0498 18.0498 16.468 18.0498 15.75V8.25C18.0498 7.53203 17.468 6.9502 16.75 6.9502H9.76562V17.0498Z"
      fill="currentColor"
    />
  </svg>
);
...
/** 搜索（figma search.svg，codechat 侧栏「搜索」按钮同款资源）：放大镜。
 *  桌面/文件面板工具条的搜索按钮与前导小图标复用本组件，替代原 codicon
 *  `codicon-search` 字体图标（同一 surface 不混图标库，2026-09-17 评论）。 */
export const SearchIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      d="M5.75181 1.56141C8.95122 0.704446 12.2402 2.60321 13.0975 5.80262C13.6001 7.67837 13.1543 9.58424 12.0555 11.0136L14.4911 13.4491C14.7644 13.7225 14.7644 14.166 14.4911 14.4393C14.2177 14.7126 13.7742 14.7126 13.5008 14.4393L11.077 12.0155C10.4431 12.5294 9.69532 12.9235 8.8563 13.1483C5.65674 14.0056 2.36699 12.1066 1.50962 8.90711C0.652581 5.70765 2.55236 2.41869 5.75181 1.56141ZM11.745 6.16492C11.0878 3.71239 8.56667 2.25705 6.11411 2.91394C3.6614 3.57115 2.20599 6.09209 2.86313 8.5448C3.52039 10.9975 6.04129 12.453 8.49399 11.7958C9.26465 11.5892 9.93631 11.1982 10.4754 10.6835C10.5057 10.6306 10.5407 10.5792 10.5858 10.5341C10.6254 10.4945 10.67 10.4626 10.7157 10.4345C11.7232 9.31604 12.1635 7.72721 11.745 6.16492Z"
      fill="currentColor"
    />
  </svg>
);
...
/** 设置-插件市场：拼图块 = 插件。设计师原型没有这一项（插件市场是新增导航，
 *  codechat-ui `settings-navigation.ts` 里没有对应资产），按 skill `icon.md`
 *  的图标源优先级第 3 条取项目已在用的同一图标库 lucide，符号沿用 puzzle。
 *
 *  形状 = 设计师 2026-09-15 在 Figma 微调后导出的 16 网格版本，path **逐字照搬**；
 *  仅按 skill `icon.md`「Use currentColor so hover, active, disabled, and danger
 *  states follow the control token」与同面口径做两处规范化：① 导出外壳里的
 *  `clipPath`（整块 16×16 矩形裁剪，无视觉作用）与外层 `<g>` 去掉，只留 `<path>`，
 *  与同面其余图标结构一致；② `stroke="black"` 改为 svg 级 `currentColor` + 1.4
 *  （浅色 #565A60 / 深色 #9A9EA5 由 CSS 控）。 */
export const SettingsPluginsIcon: React.FC<IconProps> = ({
  ...
  <svg
    ...
    className={className}
  >
    <path d="M9.95003 3.61912C10.0224 3.69155 10.1128 3.74336 10.2118 3.76923C10.3109 3.7951 10.4151 3.79408 10.5136 3.76628C10.6122 3.73847 10.7015 3.6849 10.7724 3.61106C10.8434 3.53723 10.8933 3.44582 10.9172 3.34625C10.9769 3.09749 11.1019 2.86915 11.2792 2.68475C11.4566 2.50035 11.6799 2.36655 11.9261 2.29714C12.1724 2.22773 12.4326 2.22522 12.6802 2.28985C12.9277 2.35449 13.1536 2.48394 13.3344 2.66488C13.5153 2.84581 13.6447 3.07169 13.7092 3.31925C13.7738 3.56681 13.7712 3.82711 13.7017 4.07332C13.6322 4.31954 13.4983 4.54279 13.3138 4.72006C13.1294 4.89734 12.901 5.02224 12.6522 5.0819C12.5526 5.10574 12.4612 5.15571 12.3874 5.22664C12.3136 5.29758 12.26 5.38692 12.2322 5.48546C12.2044 5.584 12.2034 5.68817 12.2292 5.78723C12.2551 5.8863 12.3069 5.97667 12.3793 6.04904L13.3482 7.01729C13.4773 7.14633 13.5796 7.29953 13.6495 7.46814C13.7193 7.63675 13.7553 7.81746 13.7553 7.99997C13.7553 8.18247 13.7193 8.36318 13.6495 8.53179C13.5796 8.7004 13.4773 8.8536 13.3482 8.98264L12.3793 9.9515C12.307 10.0239 12.2166 10.0757 12.1175 10.1016C12.0185 10.1275 11.9143 10.1265 11.8158 10.0987C11.7172 10.0709 11.6279 10.0173 11.557 9.94344C11.486 9.86961 11.4361 9.7782 11.4122 9.67863C11.3525 9.42987 11.2275 9.20153 11.0501 9.01713C10.8728 8.83273 10.6495 8.69893 10.4033 8.62952C10.157 8.56011 9.89673 8.5576 9.6492 8.62223C9.40166 8.68687 9.17582 8.81632 8.99495 8.99726C8.81408 9.17819 8.6847 9.40407 8.62015 9.65163C8.5556 9.89919 8.55821 10.1595 8.62771 10.4057C8.6972 10.6519 8.83108 10.8752 9.01554 11.0524C9.2 11.2297 9.42838 11.3546 9.67716 11.4143C9.77674 11.4381 9.86815 11.4881 9.94198 11.559C10.0158 11.63 10.0694 11.7193 10.0972 11.8178C10.125 11.9164 10.126 12.0205 10.1001 12.1196C10.0743 12.2187 10.0225 12.309 9.95003 12.3814L8.98117 13.3497C8.85213 13.4787 