...
const PluginDialog: React.FC<
  PluginDialogProps & { vscode: { postMessage: (msg: unknown) => void } }
> = ({ onClose, vscode }) => {
  const [activePluginTab, setActivePluginTab] = useState<
    "explore" | "installed" | "marketplaces"
  >("explore");
                  ...
                  <div className="plugin-detail">
                    ...
                    {selectedPlugin.marketplace && (
                      <div className="plugin-marketplace">
                        来自市场: {selectedPlugin.marketplace}
                      </div>
                    )}
                    <div className="install-options">
                      ...
                      <button
                        ...
                        onClick={() =>
                          handleInstallPlugin(selectedPlugin.id, "user")
                        }
                      >
                        <div className="install-option-title">
                          为你安装 (user)
                        </div>
                      ...
                      <button
                        className="install-option-btn"
                        onClick={() =>
                          handleInstallPlugin(selectedPlugin.id, "project")
                        }
                      >
                        <div className="install-option-title">
                          为此仓库的所有协作者安装 (project)
                        </div>
                        <div className="install-option-desc">
                          在项目配置中安装，团队成员共享
                        </div>
                      ...
                      <button
                        className="install-option-btn"
                        onClick={() =>
                          handleInstallPlugin(selectedPlugin.id, "local")
                        }
                      >
                        <div className="install-option-title">
                          仅为你在此仓库中安装 (local)
            ...
            {activePluginTab === "marketplaces" && (
              <div className="marketplaces-manager">
                <div className="add-marketplace">
                  ...
                  />
                  <button className="add-btn" onClick={handleAddMarketplace}>
                    添加
                  </button>
                </div>
