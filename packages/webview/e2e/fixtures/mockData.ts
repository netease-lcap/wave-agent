...
export class MockDataGenerator {
   ...
   */
  static createAssistantMessageWithTool(
    textContent: string,
    toolName: string,
    toolParams: string,
    toolResult?: string,
   ...
   */
  static createAssistantMessageWithToolError(
    textContent: string,
    toolName: string,
    toolParams: string,
    errorMessage: string,
  ...
  static createSampleConversation(): Message[] {
    return [
      ...
      this.createAssistantMessage(
        "好的，我来分析 PaymentService 的分布式事务实现。让我先读取相关代码。",
      ),
      this.createUserMessage(
        "请检查 src/services/payment/PaymentService.ts 中的事务逻辑",
      ),
