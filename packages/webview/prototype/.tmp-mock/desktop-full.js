...
var __waveMockCase = (() => {
  ...
  // packages/webview/prototype/mock/desktop-full.ts
  var desktop_full_exports = {};
  __export(desktop_full_exports, {
    default: () => desktop_full_default,
  });
  var desktop_full_default = {
    name: "\u684C\u9762\u7AEF\uFF1A\u5168\u529F\u80FD",
    description:
      "\u4F1A\u8BDD\u6811 + \u6D88\u606F\u6D41 + \u538B\u7F29\u6309\u94AE + \u8D26\u6237\u5361\u7247 + \u4F1A\u8BDD\u770B\u677F\u6570\u636E",
    host: "desktop",
    messages: [
      {
        message: {
      ...
      },
      {
        ...
        message: {
          ...
          // 团队余额共用模式（对齐 issue #1986 契约与 test 环境实测：
          // apiQuota.limit=null + used=本人累计 API 消耗金额）。
  ...
  return __toCommonJS(desktop_full_exports);
})();
