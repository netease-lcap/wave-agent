...
describe("main", () => {
  ...
  it("should handle --permission-mode acceptEdits argument", async () => {
    process.argv = ["node", "index.js", "--permission-mode", "acceptEdits"];
    await main();
    expect(cli.startCli).toHaveBeenCalledWith({
      restoreSessionId: undefined,
      continueLastSession: undefined,
  ...
  it("should handle --permission-mode plan argument", async () => {
    process.argv = ["node", "index.js", "--permission-mode", "plan"];
    await main();
    expect(cli.startCli).toHaveBeenCalledWith({
      restoreSessionId: undefined,
      continueLastSession: undefined,
