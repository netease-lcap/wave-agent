...
describe("inputReducer", () => {
  ...
  describe("HANDLE_KEY", () => {
    ...
    it("should show usage for bare /btw without question", () => {
    ...
    it("should show usage for '/btw ' with empty question", () => {
      const state = { ...initialState, inputText: "/btw   " };
      const result = inputReducer(state, {
        type: "HANDLE_KEY",
        payload: {
    ...
    it("should dismiss btw usage on escape", () => {
      const state: InputState = {
        ...initialState,
        btwState: {
          question: "",
  ...
  describe("selectorJustUsed blocking input after command selection", () => {
    ...
    it("should execute plan as CLI-internal command without arguments", () => {
      const state: InputState = {
        ...initialState,
        inputText: "/plan",
        cursorPosition: 5,
    ...
    it("should execute plan as CLI-internal command with a description", () => {
      const state: InputState = {
        ...initialState,
        inputText: "/plan Add user authentication",
        cursorPosition: 27,
      };
    ...
    it("should execute plan open as CLI-internal command", () => {
      const state: InputState = {
        ...initialState,
        inputText: "/plan open",
        cursorPosition: 10,
