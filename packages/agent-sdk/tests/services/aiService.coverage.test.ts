...
describe("AI Service - Branch Coverage", () => {
  ...
  describe("isGitRepository", () => {
    it("should return 'Yes' if .git directory exists", async () => {
      vi.mocked(fs.existsSync).mockReturnValue(true);

      // We need to call callAgent to trigger isGitRepository via system prompt building
    ...
    it("should return 'No' if .git directory does not exist", async () => {
