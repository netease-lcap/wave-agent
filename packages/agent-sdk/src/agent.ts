...
export class Agent {
   ...
   * Used by the CLI /plan command to avoid querying the model before the path
   * is known (the plan mode reminder needs the path to be set).
   */
  public async awaitPlanFilePath(): Promise<string | undefined> {
