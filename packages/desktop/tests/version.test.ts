...
describe('compareVersions', () => {
  ...
  it('compares minor versions', () => {
    expect(compareVersions({ major: 0, minor: 19, patch: 0 }, { major: 0, minor: 20, patch: 0 })).toBe(-1);
  });

  it('compares patch versions', () => {
    expect(compareVersions({ major: 0, minor: 19, patch: 8 }, { major: 0, minor: 19, patch: 7 })).toBe(1);
  });
