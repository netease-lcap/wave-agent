...
**Branch**: `031-model-command` | **Status**: Completed | **Date**: 2026-01-15 | **Spec**: [spec.md](./spec.md)
**Input**: Feature specification from `/specs/031-model-command/spec.md`
