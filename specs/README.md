...
| Prompt Cache Control | `cache_control` markers for Claude models on system messages, user messages, and tools | 4 | 11 | [spec](021-prompt-cache-control/spec.md) · [plan](021-prompt-cache-control/plan.md) |
| Prompt Engineering | Framework for prompt construction and management | 2 | 7 | [spec](022-prompt-engineering/spec.md) · [plan](022-prompt-engineering/plan.md) |
...
| Plan Mode | Shift+Tab plan mode for read-only analysis with incremental plan file editing | 4 | 17 | [spec](050-plan-mode/spec.md) · [plan](050-plan-mode/plan.md) |
