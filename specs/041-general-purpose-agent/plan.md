...
**Branch**: `041-general-purpose-agent` | **Date**: 2026-02-03 | **Spec**: [spec.md](./spec.md)
**Input**: Feature specification from `/specs/041-general-purpose-agent/spec.md`
...
```
specs/041-general-purpose-agent/
├── plan.md              # This file
