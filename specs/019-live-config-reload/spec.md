...
- **FR-010**: System MUST reset permissions (allow, deny, additionalDirectories) to empty arrays and permissionMode to undefined when they are missing in the new configuration during reload
