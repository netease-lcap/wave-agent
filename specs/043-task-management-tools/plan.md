...
**Branch**: `043-task-management-tools` | **Date**: 2026-02-11 | **Spec**: [/specs/043-task-management-tools/spec.md]
**Input**: Feature specification from `/specs/043-task-management-tools/spec.md`
...
```
specs/043-task-management-tools/
├── plan.md              # This file
