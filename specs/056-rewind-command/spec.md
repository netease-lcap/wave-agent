...
**Created**: 2026-02-02  
"support /rewind builtin command to revert messages. the checkpoints should be only user message, when select user message, this user message and all messages after this message should be deleted. and all file operation in these messages should be reverted too, you can save prev file content to revert."
