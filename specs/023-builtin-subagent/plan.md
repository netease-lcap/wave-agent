...
**Branch**: `023-builtin-subagent` | **Date**: 2025-12-08 | **Spec**: [spec.md](./spec.md)
**Input**: Feature specification from `/specs/023-builtin-subagent/spec.md`
