...
**Branch**: `021-long-text-placeholder` | **Date**: 2026-03-24 | **Spec**: [spec.md](./spec.md)
**Input**: Feature specification from `/specs/021-long-text-placeholder/spec.md`
...
```
specs/021-long-text-placeholder/
├── plan.md              # This file
