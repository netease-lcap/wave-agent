...
import { MCPToolManager } from '../src/utils/mcpToolManager';
import { initializeMCPClient, type MCPClient } from '../src/utils/mcp';
...
describe('MCPToolManager', () => {
  ...
  it('should initialize with MCP client when config is available', async () => {
    ...
    const mockInitializeMCPClient = vi.mocked(initializeMCPClient);
    mockInitializeMCPClient.mockResolvedValue(mockMCPClient as unknown as MCPClient);
  ...
  it('should handle initialization errors gracefully', async () => {
    const mockInitializeMCPClient = vi.mocked(initializeMCPClient);
    mockInitializeMCPClient.mockRejectedValue(new Error('Initialization failed'));
  ...
  it('should call MCP tool correctly', async () => {
    ...
    const result = await mcpToolManager.callMCPTool('test_tool', { arg: 'value' });

    expect(mockMCPClient.callTool).toHaveBeenCalledWith('test_tool', { arg: 'value' });
