...
// Mock other hooks
vi.mock("../src/hooks/useInputState", () => ({
  useInputState: () => ({
    inputText: "",
    setInputText: vi.fn(),
    cursorPosition: 0,
...
vi.mock("../src/hooks/useFileSelector", () => ({
  useFileSelector: () => ({
...
vi.mock("../src/hooks/useCommandSelector", () => ({
  useCommandSelector: () => ({
...
vi.mock("../src/hooks/useBashHistorySelector", () => ({
...
vi.mock("../src/hooks/useInputHistory", () => ({
  useInputHistory: () => ({
...
vi.mock("../src/hooks/useTextInsertion", () => ({
  useTextInsertion: vi.fn(),
}));

vi.mock("../src/hooks/useClipboardPaste", () => ({
  useClipboardPaste: () => ({
    handlePasteImage: vi.fn(),
  }),
}));

vi.mock("../src/hooks/useInputKeyboardHandler", () => ({
