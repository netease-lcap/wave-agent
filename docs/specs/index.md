...
| 功能 | 描述 | 用户故事 | 功能需求 | 链接 |
|------|------|----------|----------|------|
| 会话管理 | 高性能、基于项目的会话管理系统 | 4 | 24 | [规格](ui/session-management.md) |
...
| Clear 命令 | `/clear` 命令重置对话历史和会话 | 3 | 10 | [规格](ui/clear-command.md) |
| Rewind 命令 | `/rewind` 回退对话到上一条用户消息，同时回退文件变更 | 4 | 16 | [规格](ui/rewind-command.md) |
...
| Wave Desktop（Electron 桌面应用） |  | 21 | 53 | [规格](ui/desktop-app.md) |
| 操作确认对话框 |  | 2 | 7 | [规格](ui/action-confirm-dialog.md) |
