...
已配置 autoUpdate: true 的市场，启动时自动检查更新；也可在插件市场工具栏点「更新市场」手动拉取市场清单。有新版本时版本号显示为「已安装 vX · 最新 vY」，行内出现「更新」按钮。
...
- **插件市场**：按市场 Tab 浏览插件（带插件数），支持 全部/已安装/未安装 筛选与关键词搜索；行内安装（选作用域）/ 更新 / 更换作用域与卸载；市场切换右侧可 更新市场 / 移除市场，右侧「＋ 新建市场」为全局入口。详见 [5.2 插件](#_5-2-插件)
