      ...
      '/guide': [
        {
          ...
          items: [
            ...
            { text: '方式一：通过邀请链接邀请成员加入', link: '/guide#invite-link' },
      ...
      '/desktop': [
        {
          ...
          items: [
            ...
            { text: '基于分支的 worktree 隔离会话', link: '/desktop#基于分支的-worktree-隔离会话' },
      ...
      '/sdk': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Bang 命令回调', link: '/sdk#callbacks-bang' },
