...
**Tests**: The examples below include test tasks. Both unit and integration tests are REQUIRED for all new functionality. Ensure tests are written and failing before implementation.
...
- [ ] TXXX [P] Additional unit tests in tests/unit/ and verify `pnpm test:coverage` passes
