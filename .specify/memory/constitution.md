...
- Modified principles: Updated XI. Planning and Task Delegation to mandate agent usage for all implementation tasks.
- Added sections: None
- Removed sections: None
- Templates requiring updates: ✅ tasks-template.md, ✅ plan-template.md, ✅ .wave/rules/tasks.md
...
### XI. Planning and Task Delegation
The general-purpose agent MUST be used for all planning phases. Every phrase and decision during the planning process MUST be validated or generated by the general-purpose agent to ensure comprehensive codebase understanding and technical accuracy. Furthermore, all implementation tasks MUST be delegated to subagents to reduce context costs of the main agent.

**Rationale**: The general-purpose agent's ability to perform multi-step research and analyze complex system architectures ensures that implementation plans are grounded in the actual state of the codebase. Delegating tasks to subagents optimizes context usage and ensures high-quality implementation.
...
**Version**: 1.13.0 | **Ratified**: 2025-01-27 | **Last Amended**: 2026-03-24
